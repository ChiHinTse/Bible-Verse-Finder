...
export class TopicPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public topicProvider:TopicProvider, public statusBar:StatusBar) {
  ...
  openTopicDetailPage(title:string){
    ...
    if(title=='Bible/Scripture/Word of God'){
      ...
      this.navCtrl.push(TopicDetailPage, {chineseContent:chineseContentForDetailPage,content: topicContent, title:title});
